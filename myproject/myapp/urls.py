...
urlpatterns = [
    ...
    path("posts/<int:pk>/", views.post_detail, name="post-detail"),      # single canonical post detail
    ...
    # Profiles (use this one name everywhere)
    ...
    # Notifications (server-rendered page)
    ...
    # Auth endpoints hosted in myapp (if you use them directly)
